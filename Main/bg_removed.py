...
def BG_adder(location):  # direcoty name
    ...
    for images in os.listdir(folder_dir):
        ...
        img1 = Image.open(r"C:\Users\Raviteja K\Downloads\bg-with-black-screen-2.jpeg")  # background
...
# BG_adder(r"C:\Users\Raviteja K\PycharmProjects\opencv1\venv\images\hello")
