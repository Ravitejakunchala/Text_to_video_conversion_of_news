...
def images(final_tokens,name):
    source_directory = r"C:\Users\Raviteja K\PycharmProjects\opencv1\venv\images"
    ...
    for iterator in final_tokens:
        # print("ldfxhcv nc bddf")

        pi.download(iterator,limit=3)
        iter = '_'.join(iterator.split(' '))
        path=r'C:\Users\Raviteja K\PycharmProjects\opencv1\venv\images'
...
# tokens=['Barack Obama', 'Martin Luther King Jr.', 'social discrimination', 'illiteracy', 'Nelson Mandela', 'Mahatma Gandhi', 'women empowerment', 'untouchability', 'Gandhi', 'politicians']
# images(tokens,"hello")